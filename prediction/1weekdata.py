...
def get_answer_from_claude(question, interval_data, weather_data, zone_data, pdf_text, last_week_data):
    try:
        ...
        # last week_data
        context_last_week_data = "\n過去データ:\n" + "\n".join([f"• Time: {entry['time']} - Number of People: {entry['data']}" for entry in last_week_data])
...
context_last_week_data of num is the num of people in last data.
and context_weather is the minohc campus of prediction weather
and context_zone is the third floor area, context_pdf is the schedule of minoch campus 
