...
def get_answer_from_claude(question, suspicious_data, start_last_times, max_min_data):
    try:
...
def lambda_handler(event, context):
    ...
    answer = get_answer_from_claude(user_question, suspicious_data, project_times, max_min)
